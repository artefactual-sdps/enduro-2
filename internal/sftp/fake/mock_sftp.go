...
func (m *MockClient) Upload(arg0 context.Context, arg1 io.Reader, arg2 string) (string, async.Upload, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockClientUploadCall) Return(arg0 string, arg1 async.Upload, arg2 error) *MockClientUploadCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockClientUploadCall) Do(f func(context.Context, io.Reader, string) (string, async.Upload, error)) *MockClientUploadCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockClientUploadCall) DoAndReturn(f func(context.Context, io.Reader, string) (string, async.Upload, error)) *MockClientUploadCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
